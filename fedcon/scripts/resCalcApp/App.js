...
const help = (function(){
    $("#resCalcHelp").click(function(){
        utilsRes.showHideJs(true,"resCalcPopup");
        $('body').css("overflow", "hidden");
        const popupArea = document.getElementById("resCalcPopup");
        $(window).click(function (event) {
            if (event.target == popupArea) {
                utilsRes.showHideJs(false,"resCalcPopup");
